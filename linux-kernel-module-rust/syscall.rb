...
$rust_type = Hash[
    ...
    "off_t "=>"missing",
    "?"=>"missing",
    "unsigned long "=>"missing", "int"=>"missing", "const struct sigaction *"=>"missing", "struct sigaction *"=>"missing", "size_t"=>"missing", "sigset_t *"=>"missing", "loff_t "=>"missing", "const struct iovec *"=>"missing", "struct itimerval *"=>"missing", "off_t *"=>"missing", "unsigned "=>"missing", "int *"=>"missing", "const char *const *"=>"missing", "pid_t "=>"missing", "struct rusage *"=>"missing", "struct old_utsname *"=>"missing", "long "=>"missing", "uid_t "=>"missing", "gid_t "=>"missing", "gid_t *"=>"missing", "siginfo_t *"=>"missing", "const struct sigaltstack *"=>"missing", "struct sigaltstack *"=>"missing", "const char * "=>"missing", "struct statfs *"=>"missing", "void *"=>"missing", "u32 *"=>"missing", "u32 "=>"missing", "struct timespec *"=>"missing", "struct linux_dirent64 *"=>"missing", "clockid_t "=>"missing", "struct __kernel_timespec *"=>"missing", "struct stat *"=>"missing", "loff_t *"=>"missing"]
